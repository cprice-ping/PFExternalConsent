...
$userId = $_POST['userId'];
$peopleOU = ",ou=People,dc=anycompany,dc=co";

$acRelatedPersonId = "uid=" . $_POST['setACRelatedPersonUID'] . $peopleOU;

$objectClassVal = "anycompanyUser";

$relatedPersonArray = array("attributeName" => "anycompanyRelatedPerson",
							"modificationType" => "set",
							"values" => array($acRelatedPersonId));
							
$objectClassArray = array("attributeName" => "objectClass",
							"modificationType" => "add",
							"values" => array($objectClassVal));


$data2 = array("modifications" => array($objectClassArray, $relatedPersonArray));
...
$data2_string = json_encode($data2);
  ...
  CURLOPT_PORT => "1443",
  CURLOPT_URL => "https://pingdirectory:1443/directory/v1/uid=" . $userId . $peopleOU,
